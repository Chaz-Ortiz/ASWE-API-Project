...
$sql="Select `auto_id`, `name` from `manu_types` where `status`='active'";  
...
$devices=array();// this should say manufacturer not devices, but it's internal, doesnt matter right now
